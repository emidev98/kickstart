			...
			<Row className="campaign">
					...
					<Card
						...
						reveal={
							<p>
								...
								<br />
								<a
									href={blockchain.contractExplorer + "address/" + campaign.address}
									target="_blank"
									rel="noreferrer"
								>
					...
					<Card
						...
						reveal={
							<p>
								...
								<br />
								<a
									href={blockchain.contractExplorer + "address/" + campaign.manager}
									target="_blank"
									rel="noreferrer"
								>
				...
				<Col s={12} m={12} l={4}>
					...
					<Card
						...
						reveal={
							<p>
								When you need further information about the campaigns just navigate to the requests that
								are open and you can validate if its the kind of campaign you wish to support or if you
								already supported the campaign you can even vote for the spending requests.
							</p>
						}
						revealIcon={<Icon>more_vert</Icon>}
					...
					{isManagerAccount ? (
						<Card
							...
							reveal={
								<p>
									Being the manager of this campaign you can create new spending requests to use the
									budget of your contributors.
								</p>
							}
							revealIcon={<Icon>more_vert</Icon>}
							title="New request"
